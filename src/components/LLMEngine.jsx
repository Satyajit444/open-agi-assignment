...
export const LLMEngine = () => {
  ...
  return (
    <form className="rounded-lg shadow-lg min-w-[300px]">
      ...
      <div className="px-4 pt-2.5 flex items-start flex-col">
        ...
        <select
          ...
          className="border-[1px] rounded-[4px] w-full border-solid border-[#666666] px-3 py-1 text-sm font-normal focus:outline-none"
        >
          <option value="0.2" selected>
            0.2
          </option>
        </select>
      </div>

      <div className="pt-4 px-4 pb-2 text-xs text-[#666666] flex justify-between font-medium">
        <p>Input</p>
        <p> Output </p>
      </div>
    </form>
