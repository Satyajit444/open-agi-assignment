...
export default function Sidebar() {
  ...
  return (
    <aside className="dotted-background text-base font-medium p-6 md:min-w-[350px]">
      <div className="bg-gray-50 h-full w-full p-4 shadow-lg rounded-xl border">
        ...
        {components.map(({ id, label, Icon }) => (
          <div
            key={id}
            className="cursor-pointer border-[1.5px] items-center rounded-md border-gray-400 py-1.5 px-2.5 flex justify-between my-5"
